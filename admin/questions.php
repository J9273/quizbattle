    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Manage your quiz question bank</p>
            </div>
            <div class="flex gap-3">
                <a href="export-questions.php" 
                   class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg flex items-center gap-2 transition-all">
                    ⬇️ Download CSV
                </a>
                <a href="add-question.php" 
                   class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg flex items-center gap-2 transition-all">
                    + Add Question
                </a>
            </div>
        </div>
